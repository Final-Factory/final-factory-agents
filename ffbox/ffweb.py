...
# The name this process puts on its own outbound requests. Set here rather than in the module,
# which has no version of its own and no business knowing about a web server.
_claude_keys.USER_AGENT = "ffweb/" + VERSION
