...
- The black hole renders on the overlay "Main Camera" (base = SkyboxCamera, stack of 4); Scene Color on overlays needs `Assets/Scripts/Rendering/OpaqueTextureGlobalFeature.cs`.
